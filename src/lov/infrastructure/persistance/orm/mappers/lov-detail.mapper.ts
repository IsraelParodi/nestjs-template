...
export class ListOfValuesDetailMapper {
  static toDomain(listOfValuesEntity: ListOfValuesDetailEntity): ListOfValuesDetail {
  ...
  static toDomainEmbeded(listOfValuesEntity: ListOfValuesDetailEntity): ListOfValuesDetail {
    const listOfValues = new ListOfValuesDetail(listOfValuesEntity.id);
  ...
  static toPersistence(listOfValuesDetail: ListOfValuesDetail): ListOfValuesDetailEntity {
    ...
    entity.createdBy = this.mapUserReferenceToPersistence(listOfValuesDetail.createdBy);
    entity.updatedBy = this.mapUserReferenceToPersistence(listOfValuesDetail.updatedBy);
  ...
  private static mapKeyToDomain(listOfValuesEntity?: ListOfValuesEntity): ListOfValues {
  ...
  private static mapKeyToPersistence(listOfValues?: ListOfValues): ListOfValuesEntity {
